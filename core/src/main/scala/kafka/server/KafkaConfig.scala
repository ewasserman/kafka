...
object Defaults {
  ...
  val LogCleanerMinCompactionLagMessages = 0L
  val LogCleanerMinCompactionLagBytes = 0L
...
object KafkaConfig {
  ...
  val LogCleanerMinCompactionLagMessagesProp = "log.cleaner.min.compaction.lag.messages"
  val LogCleanerMinCompactionLagBytesProp = "log.cleaner.min.compaction.lag.bytes"
  ...
  val LogCleanerMinCompactionLagMsDoc = "How long before a message may be compacted?"
  val LogCleanerMinCompactionLagMessagesDoc = "How many subsequent messages must be added to a log partition before a message may be compacted?"
  val LogCleanerMinCompactionLagBytesDoc = "How many bytes of subsequent messages must be added to a log partition before a message may be compacted?"
  ...
  private val configDef = {
    ...
    new ConfigDef()
      ...
      .define(LogCleanerMinCompactionLagMessagesProp, LONG, Defaults.LogCleanerMinCompactionLagMessages, MEDIUM, LogCleanerMinCompactionLagMessagesDoc)
      .define(LogCleanerMinCompactionLagBytesProp, LONG, Defaults.LogCleanerMinCompactionLagBytes, MEDIUM, LogCleanerMinCompactionLagBytesDoc)
...
class KafkaConfig(val props: java.util.Map[_, _], doLog: Boolean) extends AbstractConfig(KafkaConfig.configDef, props, doLog) {
  ...
  val logCleanerMinCompactionLagMessages = getLong(KafkaConfig.LogCleanerMinCompactionLagMessagesProp)
  val logCleanerMinCompactionLagBytes = getLong(KafkaConfig.LogCleanerMinCompactionLagBytesProp)
