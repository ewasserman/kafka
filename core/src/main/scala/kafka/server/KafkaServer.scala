...
object KafkaServer {
  ...
  private[kafka] def copyKafkaConfigToLog(kafkaConfig: KafkaConfig): java.util.Map[String, Object] = {
    ...
    logProps.put(LogConfig.MinCompactionLagMessagesProp, kafkaConfig.logCleanerMinCompactionLagMessages)
    logProps.put(LogConfig.MinCompactionLagBytesProp, kafkaConfig.logCleanerMinCompactionLagBytes)
